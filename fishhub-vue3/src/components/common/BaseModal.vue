<template>
  <Teleport to="body">
    ...
    >
      ...
      >
        <div 
          class="base-modal-panel bg-white rounded-lg shadow-xl max-h-[90vh] flex flex-col"
          :style="{ width: width }"
          @click.stop
        >
          <!-- 标题栏 -->
...
@media (max-width: 767px) {
  .base-modal-panel { width: 100% !important; max-height: calc(100dvh - 32px); border-radius: 16px; }
  .base-modal-panel > div:first-child { padding: 16px 20px; }
  .base-modal-panel > div:last-child { padding-inline: 20px; }
}
</style>
