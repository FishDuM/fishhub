<template>
  <nav class="mobile-bottom-nav" aria-label="移动端主导航">
    ...
    <router-link to="/notifications" class="mobile-nav-item" active-class="mobile-nav-active" aria-label="通知">
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor"><path d="M18 9a6 6 0 1 0-12 0c0 7-3 7-3 9h18c0-2-3-2-3-9M10 21h4" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"/></svg>
    </router-link>
