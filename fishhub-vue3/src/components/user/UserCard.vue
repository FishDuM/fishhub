      ...
      <div class="flex items-center">
        ...
        <div class="user-info">
          ...
          <div v-if="type === 'user'" class="mt-[6px]">
            <span>飞鱼社区号：{{ user.fishhubId }}</span>
          </div>
...
@media (max-width: 767px) {
  .user-card { padding: 14px 4px; align-items: flex-start; }
  .avatar { width: 52px; height: 52px; }
  .user-info { min-width: 0; margin: 0 10px; font-size: 12px; }
  .nickname { overflow: hidden; font-size: 15px; text-overflow: ellipsis; }
  .follow-button { width: 68px; height: 32px; padding: 0 10px; font-size: 13px; }
}
</style> 
