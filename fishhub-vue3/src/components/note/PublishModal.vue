  ...
  <Teleport to="body">
    ...
    >
      ...
      <div v-if="visible" class="fixed inset-0 z-[101] flex items-center justify-center p-4">
        <div class="publish-dialog bg-white w-[800px] rounded-lg flex flex-col max-h-[90vh] shadow-2xl">
          ...
          <div class="publish-dialog-body flex-1 overflow-auto px-8 py-6 min-h-[500px]">
              ...
              <div class="flex gap-4">
                <button
                  ...
                  :class="noteType === 'image'
                    ? 'border-[var(--color-primary)] text-[var(--color-primary)] bg-[var(--color-surface-muted)]'
                ...
                >
                  <div class="flex items-center">
                    ...
                    <svg
                      v-if="noteType === 'image'"
                      class="w-4 h-4 ml-1.5 text-[var(--color-primary)]"
                      viewBox="0 0 24 24"
                      fill="none"
                      stroke="currentColor"
                    >
            ...
            <div class="flex gap-4 overflow-x-auto pb-4 -mx-1 px-1">
              ...
              <div
                ...
                :class="{
                  ...
                  'border-[var(--color-primary)] border-2': dragOverIndex === index && draggedItem !== index,
                  'cursor-grab': !isVideo
                }"
                :draggable="!isVideo"
                ...
                >
                  ...
                  <div class="absolute inset-0 flex items-center justify-center bg-black/20 hover:bg-black/30 transition-colors">
                    <div class="w-10 h-10 rounded-full bg-white/80 backdrop-blur-sm flex items-center justify-center">
                      <svg class="w-5 h-5 text-[var(--color-primary)]" viewBox="0 0 24 24" fill="currentColor" stroke="none">
              ...
              <div
                ...
                justify-center cursor-pointer hover:border-[var(--color-primary)] hover:bg-gray-100 transition-colors bg-gray-50/50 shrink-0"
                @click="triggerUpload"
            ...
            <div
              v-if="errors.files"
              class="text-[var(--color-danger)] text-[13px] mt-1 flex items-center"
            >
            ...
            <div class="relative mt-2">
              <div class="relative">
                <input
                  ...
                  :class="{'border-[var(--color-danger)]': errors.title}"
                />
            ...
            <div class="space-y-2 mt-4">
              ...
              <div class="relative border-t border-gray-100">
                ...
                >
                  <div class="flex items-center text-[14px] text-[var(--color-primary-label)]">
                  ...
                  >
                    <div class="max-h-[300px] overflow-auto">
                      <button
                        ...
                        :class="{'text-[var(--color-primary)]': selectedChannel?.id === channel.id}"
              ...
              <div class="relative border-t border-gray-100">
                ...
                <div class="py-4 px-4 -mx-4 mt-2">
                  <div class="flex items-center text-[14px] text-[var(--color-primary-label)] mb-3">
                    <svg class="w-4 h-4 mr-3 text-gray-500" viewBox="0 0 24 24" fill="none" stroke="currentColor">
                  ...
                  <div class="relative">
                    <div class="flex flex-wrap items-center gap-2 min-h-[40px] p-2 border border-gray-200 rounded-lg focus-within:border-[var(--color-primary)]">

                      <div
                        v-if="selectedTopic"
                        class="flex items-center bg-[var(--color-surface-muted)] text-[var(--color-primary-label)] px-2 py-1 rounded-full text-[13px]"
                      >
                    ...
                    >
                      ...
                      >
                        ...
                        <span class="text-[var(--color-primary-label)]">{{ topic.name }}</span>
                      </button>
          ...
          <div class="border-t border-gray-100 shrink-0">
            <div class="px-8 py-6 rounded-b-[20px] flex gap-4">
              ...
              <button
                class="flex-1 bg-[var(--color-primary)] text-[var(--color-primary-contrast)] py-3 rounded-full font-bold text-[18px] hover:opacity-90 cursor-pointer transition-all"
                @click="handlePublish"
              >
                发布笔记
              </button>
...
const handlePublish = async () => {
  ...
  try {
    const noteData = {
      type: noteType.value === 'video' ? 1 : 0, // 后端约定：0 图文，1 视频
      title: title.value.trim(),
    ...
    if (noteType.value === 'video') {
      noteData.videoUri = fileUrls.value[0]
    } else {
...
const onDrop = (index) => {
  ...
  // 本地文件和服务端 URL 按相同索引配对，拖拽时必须同步重排。
...
@media (max-width: 767px) {
  .publish-dialog { width: 100%; max-height: 100%; border-radius: 16px; }
  .publish-dialog > div:first-child { padding: 16px 20px; }
  .publish-dialog-body { min-height: 0; padding: 16px 20px 20px; }
  .publish-dialog-body :deep(.w-\[135px\]) { width: 104px; height: 104px; }
}
</style>
