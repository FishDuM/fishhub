...
public interface NoteService {
    ...
    Response<FindNoteActionListRspVO> findCollectedNoteList(FindNoteActionListReqVO request);

    Response<FindNoteActionListRspVO> findLikedNoteList(FindNoteActionListReqVO request);
