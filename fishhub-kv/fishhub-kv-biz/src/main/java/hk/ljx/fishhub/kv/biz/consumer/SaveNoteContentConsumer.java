package hk.ljx.fishhub.kv.biz.consumer;

import hk.ljx.framework.common.util.JsonUtils;
import hk.ljx.fishhub.kv.biz.constant.MQConstants;
import hk.ljx.fishhub.kv.biz.model.dto.PublishNoteDTO;
...
@Component
@RocketMQMessageListener(consumerGroup = "fishhub_group_" + MQConstants.TOPIC_PUBLISH_NOTE_TRANSACTION, // Group 组
