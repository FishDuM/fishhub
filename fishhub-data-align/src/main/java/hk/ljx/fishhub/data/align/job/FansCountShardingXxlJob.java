...
public class FansCountShardingXxlJob {
    ...
    public void fansCountShardingJobHandler() throws Exception {
        ...
        for (int shard = shardRange[0]; shard < shardRange[1]; shard++) {
            ...
            if (selectMapper.selectTempTableExists("t_data_align_fans_count_temp_" + tableNameSuffix) == 0) {
            ...
            for (;;) {
                ...
                userIds.forEach(userId -> {
                    ...
                    long fansTotal = selectMapper.selectCountFromFansTableByUserId(userId);
