...
public class FollowingCountShardingXxlJob {
    ...
    public void followingCountShardingJobHandler() throws Exception {
        ...
        for (int shard = shardRange[0]; shard < shardRange[1]; shard++) {
            ...
            if (selectMapper.selectTempTableExists("t_data_align_following_count_temp_" + tableNameSuffix) == 0) {
            ...
            for (;;) {
                ...
                userIds.forEach(userId -> {
                    ...
                    long followingTotal = selectMapper.selectCountFromFollowingTableByUserId(userId);
