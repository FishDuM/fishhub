...
public class UserLikeCountShardingXxlJob {
    ...
    public void userLikeCountShardingJobHandler() throws Exception {
        ...
        for (int shard = shardRange[0]; shard < shardRange[1]; shard++) {
            ...
            if (selectMapper.selectTempTableExists("t_data_align_user_like_count_temp_" + tableNameSuffix) == 0) {
            ...
            for (;;) {
                ...
                userIds.forEach(userId -> {
                    ...
                    long userLikeTotal = selectMapper.selectUserLikeCountFromNoteLikeTableByUserId(userId);
