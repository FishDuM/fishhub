...
public class CanalSchedule implements Runnable {
     ...
     * @param eventType
     */
    void processEvent(Map<String, Object> columnMap, String table, CanalEntry.EventType eventType) throws Exception {
        switch (table) {
    ...
    private void syncNotesIndexAndUserIndex(Long userId) throws Exception {
        ...
        if (bulkResponse.hasFailures()) {
            throw new IllegalStateException(
                    "Elasticsearch 批量同步部分失败: " + bulkResponse.buildFailureMessage());
        }
    }
